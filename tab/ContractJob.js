...
export default class ContractJob extends Component {
      ...
      <Container>
        {/* <Header searchBar rounded>
          ...
          <View style={{flex:1, marginTop: 70}}>
            <View style={{ flexDirection: "row", position: "absolute", bottom: 50, left: 0, right: 0, justifyContent: 'space-between' }}>
               <Button style={{flex:4, justifyContent: 'center', margin: 20, padding: 8}} danger iconLeft onPress={() => this._deckSwiper._root.swipeLeft()}>
                 <Icon name="arrow-back" />
                 
               </Button>
               <Button style={{flex:4, justifyContent: 'center', margin: 20, padding: 8}} success iconRight onPress={() => this._deckSwiper._root.swipeRight()}>
                  <Icon name="arrow-forward" />
                  <Text></Text>
                </Button>
                </View>
