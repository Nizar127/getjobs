...
export default class Feed extends Component {
  ...
  render(){
    ...
    return(
          ...
          <Card>
            ...
            <Body>
             ...
             <CardItem style={{justifyContent: 'center'}}>
                  ...
                  <Button rounded primary onPress={() => Alert.alert('Wow')} >
                        <Text>Book Now</Text>
                    </Button>  
      ...
      <Fab style={{backgroundColor: '#f8f8fa', borderColor: '#000000'}} onPress={() => this.props.navigation.navigate('UploadJob')}>
   
          <Icon name="location-outline" />
      </Fab>


   <Fab style={{backgroundColor: '#66cd00'}} onPress={() => this.props.navigation.navigate('CarouselMap')}>
